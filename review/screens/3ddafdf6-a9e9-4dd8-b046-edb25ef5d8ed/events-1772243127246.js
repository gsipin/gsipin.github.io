jQuery("#simulation")
  .on("click", ".s-3ddafdf6-a9e9-4dd8-b046-edb25ef5d8ed .click", function(event, data) {
    ...
    if(jFirer.is("#s-Path_6")) {
    ...
    } else if(jFirer.is("#mi-a56cf1ce-Text_4")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-a56cf1ce-Text_5")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-a56cf1ce-Text_6")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-a56cf1ce-Text_7")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-a56cf1ce-Text_8")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-a56cf1ce-Text_9")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-73cd8483-Image_2")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-73cd8483-Button_1")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-73cd8483-Text_2")) {
      cases = [
        {
          "blocks": [
            {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#mi-73cd8483-Text_3")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("mouseenter dragenter", ".s-3ddafdf6-a9e9-4dd8-b046-edb25ef5d8ed .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-3ddafdf6-a9e9-4dd8-b046-edb25ef5d8ed .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
